...
* Fix: `vault_app_env_defaults` not populated during deploy ([#1049](https://github.com/roots/trellis/pull/1049))
* Add `vault_app_env_defaults` ([#1048](https://github.com/roots/trellis/pull/1048))
...
* Disallow duplicate site keys within a host's `sites` ([#910](https://github.com/roots/trellis/pull/910))
...
* Add vault_sites validation ([#823](https://github.com/roots/trellis/pull/823))
...
* Simplify and improve `sites` with better defaults ([#528](https://github.com/roots/trellis/pull/528))
...
* Add `run_composer` option to `sites` so Composer can be run on the VM removing the requirement for it on the host
